...
import { secciones, horarioPreviewSeccion, horasList } from "../../data/mockData";

const emptyRows = horasList.map((h) => ({ hora: h, L:"", M:"", X:"", J:"", V:"", S:"" }));

export default function AlumnoSeccionScreen() {
